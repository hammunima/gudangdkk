    ...
    */
    ...
    public function report_keluar()
    {
        ...
        if (Input::get('jns') != '0') {
            ...
            if (Input::get('jns') == 'cKode') {
                ...
                <thead>
                    <tr style = "font-weight: bold;text-align: center">
                        ...
                        <th style = "width: 40%;border-bottom: solid;text-align: left">Tujuan Alokasi </th>
                        <th style = "width: 10%;border-bottom: solid;text-align: right">Qty</th>
                        <th style = "width: 12%;border-bottom: solid;text-align: left">Satuan</th>
                        <th style = "width: 12%;border-bottom: solid;text-align: right">Harga</th>
                        <th style = "width: 8%;border-bottom: solid;text-align: right">&nbsp;</th>
                    </tr>
            ...
            $header = '
                ...
                <thead>
                    <tr style = "font-weight: bold;text-align: center">
                        <th rowspan="2" style = "width: 5%;border-bottom: solid;vertical-align: middle">No</th>
                        <th rowspan="2" style = "width: 15%;border-bottom: solid;text-align: left">Nomor</th>
                        <th rowspan="2" style = "width: 10%;border-bottom: solid">Tanggal</th>
                        <th colspan="2" style = "width: 40%;">Tujuan Alokasi</th>
                        <th rowspan="2" style = "width: 20%;border-bottom: solid;text-align: left">Keterangan</th>
                        <th rowspan="2" style = "width: 10%;border-bottom: solid;text-align: right">&nbsp;</th>
                    </tr>
                    <tr style = "font-weight: bold;text-align: center">
                        <th style = "width: 20%;border-bottom: solid;">Bidang</th>
                        <th style = "width: 20%;border-bottom: solid;">Puskesmas</th>
                    </tr>
    ...
    public function report_stok()
    {
        ...
        for ($i = 0; $i < count($barang); $i++) {
            ...
            //$sum = array($sum[0] + $s_awal, $sum[1] + $s_msk, $sum[2] + $s_klr, $sum[3] + $barang[$i]->sum);
        }
        $content .= '
            <tr style = "vertical-align: middle;text-align: right;font-weight: bold">
                <td style="width: 10%;text-align: right;">&nbsp;</td>
