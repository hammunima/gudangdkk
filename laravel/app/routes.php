...
//Generate
Route::get('try', array('uses' => 'GenerateController@trying'));
Route::get('help', array('uses' => 'GenerateController@help'));
Route::get('help2', array('uses' => 'GenerateController@help2'));
Route::get('pkminventori', array('uses' => 'GenerateController@pkm_inventori'));


//report aset
Route::get('wkhtml', array('uses' => 'ReportController@wkhtml'));
Route::get('CETAK', array('uses' => 'ReportController@penerimaanAll'));
Route::get('pengadaan', array('uses' => 'ReportController@pengadaan'));
Route::get('transfer', array('uses' => 'ReportController@transfer_masuk'));
Route::get('inventarisasi', array('uses' => 'ReportController@inventarisasi'));
Route::get('stokaset', array('uses' => 'ReportController@stok_aset'));
Route::get('kib', array('uses' => 'ReportController@kib'));
...
Route::group(["before" => "auth"], function () {
    ...
    //Aplikasi Puskesmas
    //Aset
    Route::get('AsetMasuk', array('uses' => 'LinkController@aset_masuk', 'as' => 'aset-masuk'));
    Route::post('AsetMasuk', array('uses' => 'MasterController@store_asetmasuk', 'as' => 'aset-masuk'));
    Route::get('DataAsetMasuk', array('uses' => 'HandlerController@data_aset_masuk', 'as' => 'data-aset-masuk'));
    Route::post('DataAsetDetail', array('uses' => 'HandlerController@aset_detail', 'as' => 'get-aset-dtl'));
    Route::post('GetAsetMasuk', array('uses' => 'HandlerController@get_aset_masuk', 'as' => 'get-aset-masuk'));

    Route::get('AsetKeluar', array('uses' => 'LinkController@aset_keluar', 'as' => 'aset-keluar'));
    Route::post('AsetKeluar', array('uses' => 'MasterController@store_asetkeluar', 'as' => 'aset-keluar'));
    Route::get('DataAsetKeluar', array('uses' => 'HandlerController@data_aset_keluar', 'as' => 'data-aset-keluar'));
    //Route::post('DataAsetDetail', array('uses' => 'HandlerController@aset_detail', 'as' => 'get-aset-dtl'));
    Route::post('GetAsetKeluar', array('uses' => 'HandlerController@get_aset_keluar', 'as' => 'get-aset-keluar'));

    Route::get('EntryAset', array('uses' => 'LinkController@entry_aset', 'as' => 'entry-aset'));
    Route::post('EntryAset', array('uses' => 'MasterController@entry_aset', 'as' => 'entry-aset'));

    Route::get('DataAsetPuskesmas', array('uses' => 'LinkController@aset_data', 'as' => 'aset-data'));
    Route::post('StokAsetPuskesmas', array('uses' => 'ReportController@aset_stok', 'as' => 'aset-stok'));
    Route::get('GetDataAsetPuskesmas', array('uses' => 'HandlerController@aset_data', 'as' => 'get-aset-data'));
    ...
    Route::get('EditDetailAset', array('uses' => 'LinkController@aset_edit', 'as' => 'aset-edit'));
    Route::post('EditDetailAset', array('uses' => 'MasterController@edit_aset', 'as' => 'aset-edit'));
    Route::post('GetEditDetailAset', array('uses' => 'HandlerController@aset_editdtl', 'as' => 'aset-editdtl'));

    Route::get('KIB', array('uses' => 'LinkController@aset_kib', 'as' => 'aset-kib'));
    Route::post('KIB', array('uses' => 'ReportController@aset_kib', 'as' => 'aset-kib'));
    Route::get('KIR', array('uses' => 'LinkController@aset_kir', 'as' => 'aset-kir'));
    Route::post('KIR', array('uses' => 'ReportController@aset_kir', 'as' => 'aset-kir'));

    //Laporan - laporan
    Route::get('Laporan', array('uses' => 'LinkController@laporan', 'as' => 'laporan'));
    Route::post('Penerimaan-Aset', array('uses' => 'ReportController@penerimaan', 'as' => 'penerimaan-aset'));
    Route::get('keluarall', array('uses' => 'ReportController@pengeluaranAll', 'as' => 'pengeluaran-aset'));
    ...
    Route::get('sbbk/{id}', array('uses' => 'ReportController@sbbk', 'as' => 'nota'));
    Route::post('bend', array('uses' => 'ReportController@bend29','as'=>'bend'));
    ...
    Route::get('MasterPegawai', array('uses' => 'LinkController@dkk_pegawai', 'as' => 'dkk-pegawai'));
    Route::post('MasterPegawai', array('uses' => 'MasterController@store_pegawai', 'as' => 'dkk-pegawai'));
    Route::get('GetPegawai', array('uses' => 'HandlerController@get_pegawai', 'as' => 'get-pegawai'));
