            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default" id="tabel">
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong>Data Satuan</strong></h3>
                    </div>
                                ...
                                <div class="form-group">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li><a href="{{URL::to('expExcel/satuan')}}">Excel</a></li>
                                            <li><a target="_blank" href="{{URL::to('expPDF/satuan')}}">PDF</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="modal" id="modal_basic" tabindex="-1" role="dialog" aria-labelledby="defModalHead"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <form class="form-horizontal" method="post" action="{{route('m-satuan')}}">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal"><span
                                        aria-hidden="true">&times;</span><span
                                        class="sr-only">Close</span></button>
                            <h4 class="modal-title" id="defModalHead">Master Satuan</h4>
                        </div>
                        <div class="modal-body">
                            <div class="form-group">
                                <input type="text" class="hidden" name="id" id="id" value="">
                                <label class="col-md-3 col-xs-12 control-label">Nama Satuan</label>
...
@section('ajax')
    ...
    <script>
        ...
        function del(id) {
            ...
            if (r == true) {
                window.location.href = 'delete/satuan/' + id;
            }
            //$('[name=nama]').val(tes);
        }
    </script>
