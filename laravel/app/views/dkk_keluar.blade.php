...
@section('content')
    ...
    <div class="page-content-wrap">
        ...
        <div class="row">
            <div class="col-md-12">
                <form class="form-horizontal" id="repform" method="post" action="{{route('lap-keluar')}}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    <select class="form-control select" id="jns" name="jns">
                                        ...
                                        <option value="id_puskesmas">Per Puskesmas</option>
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    for (i = 0; i < result.dtl.length; i++) {
                        ...
                        '<td><input type="text" class="hidden" readonly name="satuan[]" value="' + result.dtl[i]['id_barang'] + '-' + result.dtl[i]['nama_satuan'] + '"><label class="control-label">' + result.dtl[i]['id_satuan'] + '-' + result.dtl[i]['nama_satuan'] + '</label></td>' +
