                                ...
                                <div class="form-group">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li><a href="{{URL::to('expExcel/supplier')}}">Excel</a></li>
                                            <li><a target="_blank" href="{{URL::to('expPDF/supplier')}}">PDF</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="modal" id="modal_basic" tabindex="-1" role="dialog" aria-labelledby="defModalHead"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <form class="form-horizontal" method="post" action="{{route('m-supplier')}}">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <input type="text" name="kota" class="form-control" placeholder="Kota Supplier"/>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <input type="text" name="fax" class="form-control" placeholder="Fax Supplier"/>
                                </div>
                            </div>
                            <div class="form-group">
