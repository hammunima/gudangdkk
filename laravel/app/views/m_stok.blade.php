...
@section('content')
    ...
    <div class="page-content-wrap">
        ...
        <div class="row">
            <div class="col-md-12">
                <form class="form-horizontal" id="repform" method="post" action="{{route('report-stok')}}">
                    <div class="panel panel-default panel-toggled " id="daftar">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group" id="p_jns">
                                ...
                                <div class="col-md-5">
                                    <select class="form-control select" name="p_jns">
    ...
    <script>
        $(document).ready(function () {
            ...
            /*$('#proses').click(function (e) {
                //e.preventDefault();
                panel_refresh($("#proses").parents(".panel"), "shown");
                $.ajax({
                    type: 'POST',
                    url: '{{route('report-stok')}}',
                    data: $("#repform").serialize(),
                    dataType: 'json',
                    success: function (result) {
                        panel_refresh($("#proses").parents(".panel"), "hidden");
                    }
                });
            });*/
        });
